...
def pre_processing(img):
    ...
    image_scaled = cv2.resize(img, None, fx=2.0, fy=2.0,
...
file_path = r"D:\Desktop\PBE\temp2.png"

image = cv2.imread(file_path)
# img = deskewing(img)
# img = border(img)
# image = cv2.resize(image, None, fx=2, fy=22, interpolation=cv2.INTER_CUBIC)
...
data = pytesseract.image_to_string(image, lang='vie_fast')
