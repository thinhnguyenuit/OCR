...
def pre_processing(img_file_path):
    ...
    #### quay anh > 90
    rotate_img = image_original #image_scaled
    newdata=pytesseract.image_to_osd(image_original)
...
img = pre_processing(img_file_path=img_path)
